...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<c:forEach items="${parentMenu}" var="parent">
			...
			<dl id="${parent.key}">
				<dt><i class="Hui-iconfont">&#xe616;</i>${parent.name}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
					<ul>
						<c:forEach items="${parent.getChildren()}" var="menu">
						<li><a _href="${ctx}/load?path=${menu.url}" data-title="${menu.name}" href="javascript:void(0)">${menu.name}</a></li>
						</c:forEach>
					</ul>
				</dd>
			</dl>
