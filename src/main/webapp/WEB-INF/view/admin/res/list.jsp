...
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <input type="text" class="input-text" style="width:250px" placeholder="输入资源名" id="" name="">
        <button type="submit" class="btn btn-success" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜索</button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="app.add('添加资源','/res/load/-1')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加资源</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c">
            ...
            <th width="40">ID</th>
            <th width="150">资源名</th>
            <th width="90">资源key</th>
            <th width="150">资料路径</th>
            <th>资源图标</th>
            <th width="130">创建时间</th>
            <th width="100">操作</th>
        </tr>
        </thead>
        <tbody id="grid_content">
        <!--
        <tr class="text-c">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20" id="grid_page"></div>
</div>
...
<script type="text/javascript" src="${ctx}/resources/lib/artTemplate/template.js"></script>
...
<script id="test" type="text/html">
    ...
    <tr class="text-c">
       ...
       <td> <a><i class="Hui-iconfont">&#xe615;</i></a>
        <a title="编辑" href="javascript:;" onclick="app.edit('资源编辑','res/load/'+{{value.id}},'800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="app.delete(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
    </tr>
    {{/each}}
...
<script type="text/javascript">
    $(function () {
        app.queryPage({url:'res/page',pageSize:2});
    });
